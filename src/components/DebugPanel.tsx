...
import { AlertCircle, ShieldAlert, Info, Activity } from 'lucide-react';
...
const DebugPanel: React.FC<DebugPanelProps> = ({ state }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-luna-900">
      ...
      {/* Validation Toggle */}
      <div className="border-t border-luna-700 p-4">
        <button
      ...
      {/* Validation Panel */}
      {showValidation && <ValidationPanel state={state} />}
    </div>
  );
};
